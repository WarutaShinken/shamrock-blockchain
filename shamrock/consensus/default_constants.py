...
testnet_kwargs = {
    ...
    "MIN_BLOCKS_PER_CHALLENGE_BLOCK": 256,  # Must be less than half of SLOT_BLOCKS_TARGET
    ...
    "SUB_EPOCH_BLOCKS": 3072,   # The number of blocks per sub-epoch, mainnet 384
    # "EPOCH_BLOCKS": 4608,  # The number of blocks per epoch, mainnet 4608. Must be multiple of SUB_EPOCH_SB
    "EPOCH_BLOCKS": 36864,  # The number of blocks per epoch, mainnet 4608. Must be multiple of SUB_EPOCH_SB
